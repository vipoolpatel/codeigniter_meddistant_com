...
if (!empty($data['doctor_image'])) {
			?>
                                    <img src="<?php echo base_url(); ?>upload_dir/doctors_image/<?php echo $data['doctor_image']; ?>" style="height: 80px; width: 100px; overflow: hidden; ">
                                    <?php }
		?>
                                </td>
                                ...
                                <td style="text-align:center;">
                                    <div class="btn-group">
                                        <a style="margin-top:3px;" onclick="showAjaxModal('<?php echo base_url('manage_doctors/popup/update_doctors/' . $data['doctor_id']); ?>');" title="Edit" href="#"><i class="simple-icon-pencil d-block"></i></a> &nbsp;&nbsp;&nbsp; <a data-url="<?php echo base_url(); ?>manage_doctors/manage_doctor/del/<?php echo $data['doctor_id'] ?>" href="javascript:void(0);" onclick="deleteRow(this);" title="Delete" data-toggle="modal" data-target="#deleteModal"><i class="iconsminds-remove d-block"></i></a>
                                    </div>
                                </td>
							</tr>
							<?php }} else {?>
