                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form class="mb-5" action="<?php echo base_url(); ?>admin/customer/update_profile" method="post" enctype = "multipart/form-data" novalidate="novalidate">
                         ...
                         <!--    <form method="post" action="<?php echo base_url(); ?>admin/customer/update_pwd/<?php echo $user_data['user_id']; ?>" id="pwd_form">
                                <div class="form-group row">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-sm-10">
                                        ...
                                        <a href="javascript:;" id="<?=$value->user_id?>" class="btn btn-primary ResetPasswordViaEmail">Reset Password Via Email</a>
                                    </div>
