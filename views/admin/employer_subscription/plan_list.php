	...
	<table id="datatable-list" class="table table-striped table-bordered dt-responsive nowrap">
        ...
        <?php
            ...
            <tr>
                ...
                <div class="btn-group">
                   <a style="margin-top:3px;" href="<?php echo base_url(); ?>admin/employer_subscription/edit_plan/<?php echo $data['employer_subscription_id'] ?>/<?php echo $data['id'] ?>" title="Edit"><i class="simple-icon-pencil d-block"></i></a> &nbsp;&nbsp;&nbsp;
                </div>
