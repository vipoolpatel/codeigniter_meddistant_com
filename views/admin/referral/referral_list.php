                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <td style="text-align:center;">
                                            <div class="btn-group">
                                                <a style="margin-top:3px;" href="<?=base_url()?>admin/agent/edit_referral/<?=$value->id?>" title="Edit"><i class="simple-icon-pencil d-block"></i></a> &nbsp;&nbsp;&nbsp;

                                                 <a data-url="<?=base_url()?>admin/agent/delete_referral/<?=$value->id?>" href="javascript:void(0);" onclick="deleteRow(this);" title="Delete" data-toggle="modal" data-target="#deleteModal"><i class="iconsminds-remove d-block"></i></a>
