                ...
                <div class="col-12">
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="#">Manage Quote Received</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Quote Received List</li>
                        </ol>
                    </nav>
...
if ($data['doctor_id'] != Null || $data['doctor_id'] != 0) {
			...
			echo '<a style="color: blue;" href="' . base_url() . 'customer_quotes_received/view_doctor_profile/' . $doctor_id . '">';
		...
		?>
											<?php if (!empty($get_cehckout_data['checkout_id'])) {?>
												<td style="width: 150px; color: #b81c23;">
														<a href="<?php echo base_url(); ?>customer_checkout/checkout_detail/<?php echo $get_cehckout_data['checkout_id'] ?>" class="btn btn-success btn-sm">View Booking Detail</a>
