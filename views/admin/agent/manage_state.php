                ...
                <div class="col-12">
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<?=base_url()?>admin/agent">Manage State</a>
                            </li>
...
<!-- Add Form Start -->
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="<?php echo base_url() . 'admin/agent/add_assign_state'; ?>" method="post" enctype="multipart/form-data" >
                                ...
                                ?>
                                	<tr>
                                        ...
                                        <td style="text-align:center;">
                                            <div class="btn-group">
                                                  <a data-url="<?=base_url()?>admin/agent/delete_assign_state/<?=$value->user_id?>/<?=$value->id?>" href="javascript:void(0);" onclick="deleteRow(this);" title="Delete" data-toggle="modal" data-target="#deleteModal"><i class="iconsminds-remove d-block"></i></a> 
