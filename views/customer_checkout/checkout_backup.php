                  ...
                  <form action="<?=base_url()?>customer_checkout/checkout" method="post" id="payment_form">
                     ...
                     <div class="form-row col-md-12 accommodation_section service-hide" style="padding: 0px;">
                        <div class="form-group col-md-6">
                           ...
                           <select name="accommodation_promotion" class="form-control" id="accommodation_promotion" <?=$required?> >
                              <option value=""> Select Promotion Type</option>
                              <?php
                              if($selected_quote_data['treatment_cost'] >= 500 && $prepayment_hospital >= 10)
                              {
                              ?>
                              <option value="50">$50 Off ($50 for one day)</option>
                           <?php }
                           ?>
                        ...
                        <div class="col-md-3" style="padding-left: 27px;margin-top: 1.7em;">
                           <input  type="radio" id="full_prepayment" class="payment_type" value="full_prepayment" checked name="prepayment_accommodation" <?=$required?>    >
                           <label  for="full_prepayment">Full Prepayment</label>
                           <p style="color:red;">(If you prefer or financed)</p>
                        </div>
                        <div class="col-md-3" style="padding-left: 27px;margin-top: 1.7em;">
                           <input type="radio" id="Prepayment" class="payment_type" value="pre_payment" name="prepayment_accommodation"  <?=$required?>  >
                           <label for="Prepayment">Prepayment</label>
                           <p style="color:red;">(If you prefer <?=!empty($prepayment_hospital) ? $prepayment_hospital : '0'?>% payment)</p>
                     ...
                     <div class="checkout-total form-row service-hide" style="padding-bottom: 10px;">
                        ...
                        <div align="right"><?=$selected_quote_data['treatment_cost']?></div>
                     </div>
                     ...
                     <div class="checkout-total form-row" style="padding-bottom: 10px;">
                        ...
                        <div align="right" id="total_checkout_price_html"><?=$selected_quote_data['treatment_cost']?></div>
...
<script type="text/javascript">
   ...
   $('form#payment_form').on('submit', function (e) {
       ...
       function cal(payment_type = '') {
           ...
           if(get_accomodations == 'yes' && get_quote_by != 'Meddistant')
           {
